...
YC_DP_SSH_PUBLIC_KEY = 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOahhVDtJEoLeIUYpSU7WF5C4P3gVFRqvjAFumnt7PQL kamenskikh7999@DESKTOP-MO3GIQ4'
YC_DP_SUBNET_ID = 'e9b8cft5tk93tpgharkt'
YC_DP_SA_ID = 'aje0tlfuk0t03ugcmk83'
YC_DP_METASTORE_URI = '10.128.0.10'
YC_BUCKET = 'airflow-hw'
...
with DAG(
    ...
    poke_spark_processing = DataprocCreatePysparkJobOperator(
        ...
        main_python_file_uri=f's3a://{YC_BUCKET}/scripts/transform_data.py',
    )
